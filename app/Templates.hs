...
flakeNix = unlines
  ...
  , "          };"
  , ""
  , "          docs = (pagdaNix.docs or pagda.lib.${system}.docBackends.html) default;"
  , "        in"
  , "          {"
  , "            packages = {"
